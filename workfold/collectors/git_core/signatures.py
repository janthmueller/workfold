...
from workfold.collectors.git_core.object_model import GitIdentity, GitObjectParseError, GitSignature
...
def parse_git_epoch(epoch_raw: bytes, *, role: str, object_id: str) -> int:
    """Parse one Git epoch while enforcing Workfold's localizable range."""
