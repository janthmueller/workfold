...
separate stages. The clusterer emits half-open semantic bands and literal event
data; only the renderer creates Rich objects or assigns green/blue/red styles.
