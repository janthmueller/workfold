...
layout. Band assignment, clustering, exact count compaction, projection, and
temporary spill storage live here. It does not know how timestamps were
collected or how Rich will display the result.
