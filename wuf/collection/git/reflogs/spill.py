...
from wuf.collection.git.reflogs.parser import parse_reflog_line
from wuf.collection.git.reflogs.reader import open_semantic_reflog, snapshot_changed
...
def visit_semantic_reflog(
    ...
    *,
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="wuf-reflog-") as directory:
