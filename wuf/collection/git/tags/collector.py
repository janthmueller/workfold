...
from wuf.collection.git.repository import GitRepository, unique_semantic_repositories
...
from wuf.collection.git.tags.parser import GitTagParseError, parse_tag_refs
from wuf.collection.git.tags.reader import collect_tag_batch, command_diagnostic
