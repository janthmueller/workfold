...
from wuf.collection.git.changes import GitFileChangeCollectionResult
from wuf.collection.git.commits import GitCollectionResult
...
from wuf.collection.git.reflogs import GitReflogCollectionResult
from wuf.collection.git.repository import GitRepositoryResolutionResult
from wuf.collection.git.tags import GitTagCollectionResult
