"""Coordinate all supported local Git evidence behind one source boundary."""
...
from wuf.collection.diagnostics import CollectorDiagnostic
...
from wuf.collection.git.commits import CollectedGitCommit, GitCollectionResult, GitCollector
from wuf.collection.git.coverage import build_git_coverage_fragment
from wuf.collection.git.evidence.models import (
    GitEvidenceCollectionResult,
    GitEvidenceRequest,
    GitObservationConsumer,
)
from wuf.collection.git.evidence.summary import build_git_evidence_summary
from wuf.collection.git.reflogs import CollectedGitReflog, GitReflogCollectionResult, GitReflogCollector
from wuf.collection.git.repository import GitRepositoryResolutionResult, GitRepositoryResolver
from wuf.collection.git.selection import GitCommitSelection
from wuf.collection.git.tags import CollectedGitTag, GitTagCollectionResult, GitTagCollector
from wuf.domain.observations import Source, TimestampKind, TimestampObservation
...
class GitEvidenceCollector:
    ...
    def collect(
        ...
        *,
        ...
        summary = build_git_evidence_summary(
            request=request,
            commit_result=commit_result,
            file_change_result=file_result,
            tag_result=tag_result,
...
__all__ = ["GitEvidenceCollector", "merge_file_change_results"]
