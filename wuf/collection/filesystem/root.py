...
from wuf.collection.diagnostics import DiagnosticSink
from wuf.collection.filesystem.accounting import AccountingBuilder
from wuf.collection.filesystem.entries import (
    entry_is_in_scope,
    entry_type,
    ignore_capability,
    ignore_diagnostic,
...
from wuf.collection.filesystem.entries import origin as build_origin
from wuf.collection.filesystem.git_inventory import collect_git_inventory_stream
...
from wuf.collection.filesystem.ignore.exclusions import filtered_inventory_disposition
...
from wuf.collection.filesystem.root_schedule import RootOwnershipScope
...
from wuf.collection.filesystem.timestamps import extract_entry
from wuf.collection.filesystem.traversal import discover_entries
from wuf.domain.coverage import Capability, CapabilityReason, RecordDisposition
from wuf.domain.observations import EntryType, TimestampKind, TimestampObservation
