...
lives in an automatically removed temporary directory and is never Wuf
application state.
"""
...
from wuf.folding.markers import (
    ChartMarker,
...
class ChartMarkerStore:
    ...
    def _start_spill(self) -> None:
        ...
        try:
            directory = tempfile.TemporaryDirectory(prefix="wuf-aggregation-")
