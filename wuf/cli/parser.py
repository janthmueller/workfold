"""Safe argparse declaration for Wuf's public CLI."""
...
from wuf.configuration.schema import SETTING_BY_KEY, SETTING_SPECS, SettingValue
...
def build_parser(*, suppress_defaults: bool = False) -> argparse.ArgumentParser:
    ...
    parser = SafeArgumentParser(
        ...
        epilog=(
            ...
            "  configuration. Event-selector styles configure source-marker symbols and\n"
            "  colors. Use --show-config to inspect effective values and origins, including\n"
            "  style rules.\n\n"
            "Accuracy notes:\n"
            ...
            "  recovered. Past uncommitted edit sessions require a watcher, which Wuf\n"
