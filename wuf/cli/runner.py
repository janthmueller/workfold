"""Public composition root for Wuf's collector-neutral pipeline."""
...
from wuf.application.execution import execute
from wuf.application.report import ReportRequirements
from wuf.collection.diagnostics import CollectorDiagnostic, DiagnosticCategory, DiagnosticSeverity
from wuf.collection.filesystem import FilesystemCollector
from wuf.collection.git.evidence import GitEvidenceCollector
from wuf.configuration.options import MarkerStyle, RunOptions
from wuf.reporting.sanitization import sanitize_terminal_text
from wuf.reporting.terminal import TerminalOptions, terminal_color_enabled, write_terminal
from wuf.reporting.terminal.options import MIN_TERMINAL_WIDTH
...
def run(
    ...
    *,
    ...
    """Execute one Wuf run and return a process-style exit status."""
...
def default_collector_services() -> CollectorServices:
    """Assemble Wuf's production collection adapters."""
