...
from wuf.domain.observations import ActivityMarker, ClassifiedMarker, Weekday
from wuf.domain.time import utc_ns_to_datetime
...
def default_schedule() -> Schedule:
    """Return Wuf's built-in weekday schedule."""
