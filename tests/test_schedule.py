...
from workfold.schedule import Schedule, ScheduleError, TimeInterval, classify_marker, default_schedule, parse_schedule
...
def test_day_set_parser_defensively_rejects_more_than_one_range_separator() -> None:
    import workfold.schedule as schedule_module
